...
-- Telescope
api.nvim_set_keymap('v', '<leader>pfp', ':lua open_visual_selection_with_telescope()<CR>', {noremap = true})

map("n", "<leader>pf", "<cmd>Telescope find_files<cr>", { desc = "Telescope find files", noremap = true })
